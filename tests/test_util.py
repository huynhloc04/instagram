...
class TestUnits(unittest.TestCase):
    ...
    def test_allowd_extension_lower(self):
        ...
        self.assertTrue(allowed_file("animation.jpeg"), "Test failed for animation.jpeg")
    ...
    def test_disallowed_extension(self):
        ...
        self.assertFalse(allowed_file("animation.jpgc"), "Test failed for animation.jpgc")

    # Test case #4: Filename have multiple dot characters
    def test_multiple_dots(self):
        self.assertFalse(allowed_file("archive.zip.tar"), "Test failed for archive.zip.tar")
        self.assertTrue(allowed_file("demo.py.JPEG"), "Test failed for demo.py.JPEG")
        self.assertFalse(allowed_file("animation.txt.jpgc"), "Test failed for animation.txt.jpgc")
